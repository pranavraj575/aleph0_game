...
To replicate the examples shown:
```shell
python aleph0_game/scripts/play_game.py tic-tac-toe --overwrite --save_gif images/sample_ttt_game.gif --duration 300 --random_players 0 1 --screenshot_dir output/tic_tac_toe --opp_render --ascii_text_size 60
python aleph0_game/scripts/play_game.py mnk --args m:4 n:4 k:4 --overwrite --save_gif images/sample_mnk4_game.gif --duration 300 --random_players 0 1 --screenshot_dir output/mnk4 --opp_render --ascii_text_size 50
python aleph0_game/scripts/play_game.py mnk --args m:5 n:5 k:5 --overwrite --save_gif images/sample_mnk5_game.gif --duration 300 --random_players 0 1 --screenshot_dir output/mnk5 --opp_render --ascii_text_size 40
```
