...
class State:
    # current board
    board: torch.Tensor
    # mask to obtain the game board at start player's turn from the current board
...
class Chess5d(Game):
    ...
    def start_turn_board_and_center(self, state: State):
        """
        uses state.start_turn_board_mask to get board of last player at state
        :param state:
        :return: board, center_timeline
        """
