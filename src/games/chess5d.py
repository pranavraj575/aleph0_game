...
if __name__ == "__main__":
    ...
    b = c.step_weak_type(b, (-1, [0, 0, 1, 0]))[0]
    b = c.step_weak_type(b, (-1, [0, 0, 3, 0]))[0]
    b = c.step_weak_type(b, (0, -torch.ones(4)))[0]

    b = c.step_weak_type(b, (-1, [1, 0, 6, 0]))[0]
    b = c.step_weak_type(b, (-1, [1, 0, 5, 0]))[0]
    b = c.step_weak_type(b, (0, -torch.ones(4)))[0]

    b = c.step_weak_type(b, (-1, [2, 0, 3, 0]))[0]
    b = c.step_weak_type(b, (-1, [2, 0, 4, 0]))[0]
    b = c.step_weak_type(b, (0, -torch.ones(4)))[0]

    b = c.step_weak_type(b, (-1, [3, 0, 6, 1]))[0]
    b = c.step_weak_type(b, (-1, [3, 0, 4, 1]))[0]
    b = c.step_weak_type(b, (0, -torch.ones(4)))[0]

    b = c.step_weak_type(b, (-1, [4, 0, 4, 0]))[0]
    b = c.step_weak_type(b, (-1, [4, 0, 5, 1]))[0]
    b = c.step_weak_type(b, (0, -torch.ones(4)))[0]

    b = c.step_weak_type(b, (-1, [5, 0, 7, 1]))[0]
    b = c.step_weak_type(b, (-1, [3, 0, 5, 1]))[0]
    b = c.step_weak_type(b, (0, -torch.ones(4)))[0]

    b = c.step_weak_type(b, (-1, [4, 1, 4, 0]))[0]
    b = c.step_weak_type(b, (-1, [4, 1, 5, 1]))[0]
    b = c.step_weak_type(b, (0, -torch.ones(4)))[0]
